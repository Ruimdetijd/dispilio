...
`,t.TextWrapper=n.default.div`
	...
	padding-left: 2em;
	position: relative;
`,t.Layers=n.default.div`
	display: grid;
	grid-column-gap: 2%;
	${e=>0===e.orientation?"\n\t\t\t\tgrid-template-columns: 1fr 1fr;\n\t\t\t\tgrid-template-rows: 100% auto;\n\t\t\t":1===e.orientation?"grid-template-rows: 1fr 1fr;":void 0}
`,t.MetadataItem=n.default.li`
	margin-bottom: .5em;
...
`,t.small=r.css`
		...
		font-size: .8em;
		margin-left: .5em;
`,t.ItemInText=n.default.li`
	background-color: ${e=>e.active?e.node.attributes[o.COLOR_ATTRIBUTE_NAME]:"initial"};
	border-radius: .2em;
